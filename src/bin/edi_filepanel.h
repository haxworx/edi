...
/**
 * Cancel pending async tree state restoration.
 *
 * Used when the file panel is toggled to avoid delayed UI jumps.
 *
 * @ingroup UI
 */
void edi_filepanel_restore_pending_cancel(void);
/**
 * @}
 */
